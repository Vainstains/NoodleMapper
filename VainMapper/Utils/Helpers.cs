...
public static class Helpers
{
    ...
    public static Sprite LoadSprite(string asset) {
        var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{CurrentPluginName}.Resources.{asset}");
    ...
    public static Sprite LoadSprite(string asset, int edgePx)
    {
        var stream = Assembly.GetExecutingAssembly()
            .GetManifestResourceStream($"{CurrentPluginName}.Resources.{asset}");
